...
const string strMessageMagic = "Prime33 Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Prime33: 1 days
static const int64 nTargetSpacing = 120; // Prime33: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Prime33 miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Prime33", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xec6707ea39b12bac43f021ab8f95f45b08594d0e7cbec19786c52690159b5e1f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The Singularity is here";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1376715908; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1376715908;
            block.nNonce   = 527531;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xadcaa5fa45bb0cc721e51e188981b22b5afb55c5cd5576393def9884cd48ee22"));
